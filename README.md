...
🎯 Problem Statement
Educational institutions need a way to analyze and predict student performance in advance so that timely academic interventions can be planned.
This project predicts student performance using features such as:
